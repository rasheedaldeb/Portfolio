...
const skills = [
  ...
  { name: "redux-toolkit", level: 65, category: "state management" },
  { name: "Zustend", level: 65, category: "state management" },
];

const categories = ["all", "frontend", "tools", "state management"];
